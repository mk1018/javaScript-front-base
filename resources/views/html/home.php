    ...
    var mlist = {
      ...
      setReferralCode: function() {
        $.when(
          ...
          tag  = '<select class="custom-select" id="intro" name="intro" onchange="change()">';
          ...
          // $("#referral_code").val($("#intro").val());
          // $("#referral_code").html('<a href="'+$('#intro').val()+'" target="_blank">'+'LINK'+'</a>');
    ...
    <section class="px-md-5 mx-md-5 text-center text-lg-left dark-grey-text">
      <div class="row">
        ...
        <div class="col-md-9 mb-4 mb-md-0">
          ...
          <!-- <input type="text" id="referral_code" value="" readonly> -->
          <div class="border text-justify" id="referral_code" style="word-wrap:break-word;"></div>
		  </p>
		  <button class="btn btn-brown btn-md ml-0" type="button" id="to-clipborad">To clipborad<i class="fas fa-copy ml-2"></i></button>
        </div>
      </div>
    </section>
...
$(function() {
  $('#to-clipborad').on('click', function(){
    // コピーする文章の取得
    let text = $('#intro').val();
    // テキストエリアの作成
    ...
    // アラート文の表示
    alert("コピーしました");
    // $('#to-clipborad').show().delay(2000).fadeOut(400);
  });
});
</script>
